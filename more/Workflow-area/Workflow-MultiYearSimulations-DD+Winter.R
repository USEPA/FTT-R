...
parameters[[currentScenarioName]]$z_winter<-inputWinterSizeCutoff
...
parameters[[currentScenarioName]]$s_winter<-winterSurvivalProbs

# Set winter dates
winterDates<-SetWinterDates(winterStartDate=inputWinterStart,winterEndDate=inputWinterEnd)
parameters[[currentScenarioName]]$is_winter<-winterDates
